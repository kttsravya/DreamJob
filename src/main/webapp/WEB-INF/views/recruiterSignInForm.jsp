...
<div id="body">
	<div id="container" align="center">
		...
		<div id="aDiv"
			style="width: 400px; text-align: center; position: right; margin-top: 40px; color: white;">
			<br>
			<h2>Sign In with DreamJob Account</h2>

			<form action="recruiterSignInValidation">
				...
				<div id="bDiv" align="center">
					<p>
						Don't have an Account?<a href="recruiterSignUpForm">Sign Up
							for Free</a>
					</p>
...
<title>Recruiter Sign In form</title>
<style type="text/css">
form {
